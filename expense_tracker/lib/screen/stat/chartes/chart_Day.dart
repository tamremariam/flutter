...
class MyChartDay extends StatefulWidget {
  const MyChartDay({super.key});

  @override
  State<MyChartDay> createState() => _MyChartState();
}

class _MyChartState extends State<MyChartDay> {
  @override
