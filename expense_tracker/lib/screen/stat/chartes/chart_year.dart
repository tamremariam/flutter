...
class MyChartYear extends StatefulWidget {
  const MyChartYear({super.key});

  @override
  State<MyChartYear> createState() => _MyChartState();
}

class _MyChartState extends State<MyChartYear> {
  @override
